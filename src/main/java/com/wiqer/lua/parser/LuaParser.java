...
package com.wiqer.lua.parser;

import com.wiqer.lua.*;
import com.wiqer.lua.ast.*;
...
/** Root production. */
  ...
  final public Stat Stat() throws ParseException {
    ...
    case BREAK:
      jj_consume_token(BREAK);
                  s=Stat.breakstat(); L(s,i); {if (true) {
        return s;
    }
    }
      break;
    case GOTO:
      ...
      n = jj_consume_token(NAME);
                          s=Stat.gotostat(n.image); L(s,i); {if (true) {
        return s;
    }
    }
      break;
    ...
    case WHILE:
      ...
      b = Block();
      jj_consume_token(END);
                                               s=Stat.whiledo(e,b); L(s,i); {if (true) {
        return s;
    }
    }
      break;
    case REPEAT:
      ...
      e = Exp();
                                             s=Stat.repeatuntil(b,e); L(s,i); {if (true) {
        return s;
    }
    }
      break;
    ...
    default:
      ...
      if (jj_2_1(3)) {
        ...
        b = Block();
        jj_consume_token(END);
                                                                                                          s=Stat.fornumeric(n.image,e,e2,e3,b); L(s,i); {if (true) {
              return s;
          }
          }
      } else {
        ...
        case FOR:
          ...
          b = Block();
          jj_consume_token(END);
                                                                     s=Stat.forgeneric(nl,el,b); L(s,i); {if (true) {
            return s;
        }
        }
          break;
        case FUNCTION:
          ...
          fn = FuncName();
          fb = FuncBody();
                                                 s=Stat.functiondef(fn,fb); L(s,i); {if (true) {
            return s;
        }
        }
          break;
        default:
          ...
          if (jj_2_2(2)) {
            ...
            n = jj_consume_token(NAME);
            fb = FuncBody();
                                                                 s=Stat.localfunctiondef(n.image,fb); L(s,i); {if (true) {
                  return s;
              }
              }
          } else {
            ...
            case LOCAL:
              ...
              default:
                ...
                ;
                                                       ...
                                                       s=Stat.localassignment(nl,el); L(s,i); {if (true) {
                return s;
            }
            }
              break;
  ...
  final public Stat ReturnStat() throws ParseException {
    ...
    default:
      ...
      ;
                                              ...
                                              s=Stat.returnstat(el); L(s,i); {if (true) {
          return s;
      }
      }
    throw new Error("Missing return statement in function");
  ...
  final public Stat ExprStat() throws ParseException {
    ...
    default:
      ...
      ;
          ...
          if (s==null) { s=Stat.functioncall(assertfunccall(p)); } L(s,i); {if (true) {
          return s;
      }
      }
    throw new Error("Missing return statement in function");
  ...
  final public Stat Assign(Exp.VarExp v0) throws ParseException {
    ...
    jj_consume_token(71);
    el = ExpList();
                                                                s=Stat.assignment(vl,el); L(s,i); {if (true) {
          return s;
      }
      }
    throw new Error("Missing return statement in function");
  ...
  final public Exp.PrimaryExp PrefixExp() throws ParseException {
    ...
    case NAME:
      n = jj_consume_token(NAME);
                                          p=Exp.nameprefix(n.image); L(p,i); {if (true) {
        return p;
    }
    }
      break;
    case 75:
      ...
      e = Exp();
      jj_consume_token(76);
                                  p=Exp.parensprefix(e); L(p,i); {if (true) {
        return p;
    }
    }
      break;
  ...
  final public Exp.PrimaryExp PostfixOp(Exp.PrimaryExp lhs) throws ParseException {
    ...
    case 73:
      jj_consume_token(73);
      n = jj_consume_token(NAME);
                                                  p=Exp.fieldop(lhs, n.image); L(p,i); {if (true) {
        return p;
    }
    }
      break;
    case 77:
      ...
      e = Exp();
      jj_consume_token(78);
                                                  p=Exp.indexop(lhs, e); L(p,i); {if (true) {
        return p;
    }
    }
      break;
    case 74:
      ...
      n = jj_consume_token(NAME);
      a = FuncArgs();
                                          p=Exp.methodop(lhs, n.image,a); L(p,i); {if (true) {
        return p;
    }
    }
      break;
    ...
    case 80:
      a = FuncArgs();
                                                  p=Exp.functionop(lhs, a); L(p,i); {if (true) {
        return p;
    }
    }
      break;
  ...
  final public FuncArgs FuncArgs() throws ParseException {
    ...
    case 75:
      ...
      jj_consume_token(76);
                                          a=FuncArgs.explist(el); L(a,i); {if (true) {
        return a;
    }
    }
      break;
    case 80:
      tc = TableConstructor();
                                          a=FuncArgs.tableconstructor(tc); L(a,i); {if (true) {
        return a;
    }
    }
      break;
    ...
    case CHARSTRING:
      s = Str();
                                                          a=FuncArgs.string(s); L(a,i); {if (true) {
        return a;
    }
    }
      break;
  ...
  final public Exp SimpleExp() throws ParseException {
    ...
    case NIL:
      jj_consume_token(NIL);
                                                  e=Exp.constant(LuaValue.NIL); L(e,i); {if (true) {
        return e;
    }
    }
      break;
    case TRUE:
      jj_consume_token(TRUE);
                                                  e=Exp.constant(LuaValue.TRUE); L(e,i); {if (true) {
        return e;
    }
    }
      break;
    case FALSE:
      jj_consume_token(FALSE);
                                                  e=Exp.constant(LuaValue.FALSE); L(e,i); {if (true) {
        return e;
    }
    }
      break;
    case NUMBER:
      n = jj_consume_token(NUMBER);
                                                  e=Exp.numberconstant(n.image); L(e,i); {if (true) {
        return e;
    }
    }
      break;
    ...
    case CHARSTRING:
      s = Str();
                                                  e=Exp.constant(s); L(e,i); {if (true) {
        return e;
    }
    }
      break;
    ...
    case 80:
      c = TableConstructor();
                                  e=Exp.tableconstructor(c); L(e,i); {if (true) {
        return e;
    }
    }
      break;
    case FUNCTION:
      b = FunctionCall();
                                          e=Exp.anonymousfunction(b); L(e,i); {if (true) {
        return e;
    }
    }
      break;
  ...
  final public FuncBody FuncBody() throws ParseException {
    ...
    b = Block();
    jj_consume_token(END);
                                                    f=new FuncBody(pl,b); L(f,i); {if (true) {
          return f;
      }
      }
    throw new Error("Missing return statement in function");
  ...
  final public ParList ParList() throws ParseException {
    ...
    case NAME:
      ...
      default:
        ...
        ;
                                                  ...
                                                  p=new ParList(l,v); L(p,i); {if (true) {
        return p;
    }
    }
      break;
    case 79:
      jj_consume_token(79);
                 p=new ParList(null,true); L(p,i); {if (true) {
        return p;
    }
    }
      break;
  ...
  final public TableField Field() throws ParseException {
    ...
    case 77:
      ...
      jj_consume_token(71);
      rhs = Exp();
                                                  f=TableField.keyedField(exp,rhs); L(f,i); {if (true) {
        return f;
    }
    }
      break;
    default:
      ...
      if (jj_2_7(2)) {
        ...
        jj_consume_token(71);
        rhs = Exp();
                                                  f=TableField.namedField(name.image,rhs); L(f,i); {if (true) {
              return f;
          }
          }
      } else {
        ...
        case 83:
          rhs = Exp();
                                                  f=TableField.listField(rhs); L(f,i); {if (true) {
            return f;
        }
        }
          break;
